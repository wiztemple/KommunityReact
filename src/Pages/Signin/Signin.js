        ...
        <div className="app">
            <div className="shelter">
                <div className="columns">
                    ...
                    <div className="col-4">
                        <div className="py-2">
                            <h1 className="text-center"><Link className="text-blue logo" to="/">Kommunity</Link></h1>
                            <h2 className="text-center text-grey">Sign in to Kommunity</h2>
                            <div className="form-card">
                                <form id="signin">
                                    <div className="msg"></div>
                                    <span className="js__errormsg"></span>
                                    ...
                                    <button type="submit" className="btn btn-block btn-blue ripple" id="login">Sign In</button>
                                </form>
                            </div>
                            <div className="other__option">
                                Don't have an account yet? <Link className="text-blue" to="/signup">Create Account</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-4"></div>
